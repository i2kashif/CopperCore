# GitHub Issues for "Now (Next 5)" Priorities
...
**Labels:** `feature`, `M1`, `frontend`, `backend`, `auth`, `foundation`  
...
**Labels:** `feature`, `M1`, `frontend`, `backend`, `admin`, `company-mgmt`  
**Milestone:** M1: DB/RLS Foundation
...
**Labels:** `feature`, `M1`, `frontend`, `user-experience`, `session-management`  
**Milestone:** M1: DB/RLS Foundation
...
**Labels:** `feature`, `M1`, `frontend`, `backend`, `realtime`, `infrastructure`  
**Milestone:** M1: DB/RLS Foundation  
**Acceptance ID:** 12.7
...
**Labels:** `feature`, `M1`, `backend`, `work-orders`, `validation`  
**Milestone:** M1: DB/RLS Foundation  
**Acceptance ID:** 12.1
